 ...
 * <code>android:name</code> or {@link MikeFragmentNavigator.Destination#setClassName(String)}.
 * <p>
 ...
 */
@Navigator.Name("mikeFragment")
public class MikeFragmentNavigator extends Navigator<MikeFragmentNavigator.Destination> {
    ...
    public MikeFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                             int containerId) {
        mContext = context;
    ...
    @NonNull
    @Override
    public MikeFragmentNavigator.Destination createDestination() {
        return new MikeFragmentNavigator.Destination(this);
    }
    ...
    @Nullable
    @Override
    public NavDestination navigate(@NonNull MikeFragmentNavigator.Destination destination, @Nullable Bundle args,
...
//        ft.replace(mContainerId, frag);
        ...
        if (navigatorExtras instanceof MikeFragmentNavigator.Extras) {
            MikeFragmentNavigator.Extras extras = (MikeFragmentNavigator.Extras) navigatorExtras;
    ...
    /**
     * NavDestination specific to {@link MikeFragmentNavigator}
     */
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(MikeFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param fragmentNavigator The {@link MikeFragmentNavigator} which this destination
         *                          will be associated with. Generally retrieved via a
         *                          {@link NavController}'s
         *                          {@link NavigatorProvider#getNavigator(Class)} method.
         */
        public Destination(@NonNull Navigator<? extends MikeFragmentNavigator.Destination> fragmentNavigator) {
         ...
         *                  destination
         * @return this {@link MikeFragmentNavigator.Destination}
         */
        @NonNull
        public final MikeFragmentNavigator.Destination setClassName(@NonNull String className) {
    ...
    public static final class Extras implements Navigator.Extras {
        ...
        /**
         * Builder for constructing new {@link MikeFragmentNavigator.Extras} instances. The resulting instances are
         * immutable.
         */
        public static final class Builder {
             ...
             * @return this {@link MikeFragmentNavigator.Extras.Builder}
             */
            @NonNull
            public MikeFragmentNavigator.Extras.Builder addSharedElements(@NonNull Map<View, String> sharedElements) {
             ...
             */
            @NonNull
            public MikeFragmentNavigator.Extras.Builder addSharedElement(@NonNull View sharedElement, @NonNull String name) {
                mSharedElements.put(sharedElement, name);
                return this;
            }

            /**
             * Constructs the final {@link MikeFragmentNavigator.Extras} instance.
             *
             * @return An immutable {@link MikeFragmentNavigator.Extras} instance.
             */
            @NonNull
            public MikeFragmentNavigator.Extras build() {
                return new MikeFragmentNavigator.Extras(mSharedElements);
            }
        }
    }
}
