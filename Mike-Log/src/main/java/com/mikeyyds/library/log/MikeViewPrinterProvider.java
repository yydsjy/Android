...
public class MikeViewPrinterProvider {
    ...
    public MikeViewPrinterProvider(FrameLayout rootView,RecyclerView recyclerView){
    ...
    public void showFloatingView(){
        ...
        params.bottomMargin = MikeDisplayUtil.dp2px(100,recyclerView.getResources());
    ...
    private void showLogView() {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, MikeDisplayUtil.dp2px(160,rootView.getResources())
        );
